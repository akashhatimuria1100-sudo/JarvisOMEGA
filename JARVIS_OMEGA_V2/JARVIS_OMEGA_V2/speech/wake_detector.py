"""
speech/wake_detector.py — JARVIS OMEGA V2 Wake Word Detector
Supports: voice wake word + double-Ctrl hotkey.
Uses Whisper listener for better accuracy.
"""
...
class WakeWordDetector:
    ...
    def __init__(self, wake_word: str = "jarvis", callback=None, settings: dict = None):
    ...
    def _listen_loop(self):
        ...
        while not self._stop.is_set():
            try:
                ...
                if text:
                    lower = text.lower()
                    if self.wake_word in lower or f"hey {self.wake_word}" in lower:
